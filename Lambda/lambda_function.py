    ...
    if age is not None:
        if age < 21 or age > 65:
            return build_validation_result(
                False,
                "age",
                f"You entered {age}. You be between 21 and 65 years old "
                "to use this service."
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investment_amount",
                "Please enter an amount greater than or equal to 5000 to receive a recommendation.",
            )
    ...
    if risk_level is not None:
        if risk_level not in ['None', 'Low', 'Medium', 'High']:
            return build_validation_result(
                False,
                "risk_level",
                "You must enter: None, Low, Medium, or High ",
                )        
